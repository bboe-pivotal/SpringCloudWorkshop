...
link:/README.md#course-materials[Course Materials home] | link:/session_01/lab_03/lab_03.adoc[Lab 3 - Scaling Applications] | link:/session_03/lab_05/lab_05.adoc[Lab 5 - Build a Hypermedia-Driven RESTful Web Service with Spring Data REST]
